            ...
            <div className="w-full">
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col bg-slate-200 relative w-full items-center justify-between py-16 md:py-32 gap-8 ">
                        ...
                        <div className='prose flex-row flex space-x-8'>
                            <div contentEditable="false" className="socitem flex flex-row space-x-2 text-sm ">
                            ...
                            <div contentEditable="false" className="socitem flex flex-row space-x-2 items-center text-sm ">
                                <div contentEditable="false" className="socicon">
                                    <a href="https://github.com/anbani" target="_blank" rel="noopener noreferrer nofollow" title="Github" className="flex items-center ">
                        ...
                        <div contentEditable="false" className="font-firago text-sm text-justify prose px-6 text-secondary-700 drop-shadow-sm">
                            ...
                            The field I'm practicing is called Machine Learning which concerns itself with solving conventionally unprogrammable tasks with a bunch of clever algorithms abstracted as iterative learning tasks. For the past decade, researchers armed with ML tools have been exceeding super-human comprehension every year in a range of fields be it vision, speech recognition, machine translation or playing GO!
                            ...
                            On this website, you'll find some of the projects I worked on spanning but not limited to Data Science and ML, Web & Mobile apps, Music, Design, Typography, and so on. <br /><br />

                            <div className='bg-slate-100 p-4 -m-4 mt-4'>
